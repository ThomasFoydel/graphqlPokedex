...
<h2>Description</h2>
<p>A pokedex application built in MERN stack with apollo graphql for communication between front-end and back-end, and react-spring animations.</p>
<p>A year ago I made a MERN app that queried a cool graphql server by Lucas Bento -however- Lucas Bento's project is no longer running, which left my project without a server to query.</p>
